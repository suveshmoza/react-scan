...
const useGarbageCollectElements = (notificationEvents: NotificationsState["events"]) => {
  useEffect(() => {
            ...
            case "interaction": {
              return (
                <>
                  ...
                  <div className={cn(["flex items-center gap-x-3"])}>
                    <span className="text-[#6F6F78] text-xs font-medium">Total Time</span>
                    <span className="text-[#E4E4E7] bg-[#27272A] px-1.5 py-1 rounded-sm text-xs">
                      {getTotalTime(event.timing).toFixed(0)}ms
                    </span>
                  </div>
                  <div className={cn(["flex items-center gap-x-3"])}>
                    <span className="text-[#6F6F78] text-xs font-medium">Occurred</span>
                    <span className="text-[#E4E4E7] bg-[#27272A] px-1.5 py-1 rounded-sm text-xs">
